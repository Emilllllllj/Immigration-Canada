...
def update_input_container(input_dropdown-statistics):
...
def update_output_container(..., .....):
    if input_dropdown-statistics == 'Recession Period Statistics':
...
# Plot 4 bar chart for the effect of unemployment rate on vehicle type and sales
        une_rec= data.groupby('Unemployment_Rate','Vehicle_Type')['Advertising_Sales'].mean().reset_index()
        R_chart4 = dcc.Graph(
